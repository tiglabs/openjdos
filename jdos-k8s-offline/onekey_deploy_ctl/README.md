工程目录结构
    ...
    一: 创建ks8集群任务
        post url/environments/environment_id
            ...
            "environment_params": { "master-host-list":["root:111111@192.168.14.201"],
                   "etcd-host-list":["root:111111@192.168.14.201", "root:111111@192.168.14.202", "root:111111@192.168.14.203"]}
            "environment_params":"create  k8s cluster"
            }
            证书登陆改为如下
            {
            "environment_type": 1,
            "environment_params": { "master-host-list":["192.168.14.201"],
                   "etcd-host-list":["192.168.14.201", "192.168.14.202", "192.168.14.203"],
            "node-host-list":["192.168.14.201", "192.168.14.202", "192.168.14.203"],
    ...
    四： 增加k8s  节点
        ...
        {
        "environment_type": 3,
        "environment_params": { "master-host-list":["192.168.14.204"],         ### 增加的master 节点
